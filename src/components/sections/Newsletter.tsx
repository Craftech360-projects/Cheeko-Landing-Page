            ...
            <div className="relative z-10 py-4 sm:py-6 md:py-8 lg:py-4 xl:py-8">
              <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-2 xl:gap-6 w-full px-3 sm:px-4 lg:px-3 xl:px-8 items-center">
                ...
                <div className="hidden lg:flex items-center justify-center lg:justify-end">
                  {imageError ? (
                    // Fallback: Simple icon/graphic when image fails
                    <div className="w-full h-auto lg:max-w-[450px] xl:max-w-[700px] flex items-center justify-center bg-white/10 rounded-lg p-8">
                      <div className="text-center text-white/80">
                        ...
                        <p className="text-sm font-medium">Join Cheeko Club</p>
                      </div>
                    </div>
                  ) : (
                    <Image
                      ...
                      priority
                      onError={() => {
                        console.log('[Newsletter] Newsletter image failed to load, using fallback graphic');
                        setImageError(true);
                      }}
                    />
                  )}
