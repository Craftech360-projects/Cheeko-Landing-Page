...
export function PrivacyPolicy() {
  return (
    <section id="privacy-policy" className="bg-[#f7fbfe] min-h-screen py-16 px-4 sm:px-6 lg:px-8">
      <div className="container max-w-4xl mx-auto">
        <h1 className="font-bold text-[#1e1e1e] text-3xl md:text-[42px] mt-12 font-baloo text-center">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="font-bold text-[#1e1e1e] text-2xl md:text-[28px] mt-8 mb-4">
            1. Introduction
          </h2>
          ...
          <h3 className="font-bold text-[#1e1e1e] text-xl md:text-[22px] mt-6 mb-3">
            3.1 Personal Data
          </h3>
          <p className="text-[#1e1e1eb2] mb-4">
          ...
          <ul className="list-disc pl-6 mb-6 text-[#1e1e1eb2]">
            <li>Toy 6 digit verification ID</li>
            <li>
          ...
          <ul className="list-disc pl-6 mb-6 text-[#1e1e1eb2]">
            <li>
              To provide and maintain our Service, including toy activation
            </li>
